...
const FAQ: QA[] = [
  {
    ...
    a: "Your router's IP (the 'default gateway') is the local address you type into a browser to open its settings. It's most often 192.168.1.1, 192.168.0.1 or 10.0.0.1, and it's a private address used only inside your home network.",
  },
  {
    ...
    <>
      ...
      <main className="container">
        ...
        <article className="content">
          ...
          <p>
            Your <strong>router IP</strong> is private, so it only works inside
