...
const FAQ: QA[] = [
  {
    ...
    a: "An MX (Mail eXchange) record tells other mail servers where to deliver email for a domain. Each MX record points to a mail server hostname and has a priority, and lower numbers are tried first.",
  },
  {
      ...
      <main className="container">
        ...
        <article className="content">
          ...
          <ul>
            ...
            <li>
              That email authentication is set up, so verify{" "}
